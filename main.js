const alphabet = [
  ...
  const output = document.getElementById('outputCeaser');
  
  form.addEventListener ('submit',event => {
    event.preventDefault();
    output.innerHTML = [... form.plaintext.value ].map(char => encryptCeaser(char)).join('');
  }
  );
...
// funtion to Fetch the position of a specific character in the table
